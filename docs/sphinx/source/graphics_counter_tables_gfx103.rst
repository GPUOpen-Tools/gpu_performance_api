...
.. csv-table::
    ...
    "RayTriTests", "The number of ray triangle intersection tests."
    "RayBoxTests", "The number of ray box intersection tests."
    "TotalRayTests", "Total number of ray intersection tests, includes both box and triangle intersections."
    "RayTestsPerWave", "The number of ray intersection tests per wave."
