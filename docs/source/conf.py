...
# -*- coding: utf-8 -*-
#
# GPUPerfAPI documentation build configuration file, created by
# sphinx-quickstart on Wed Jan 10 14:37:31 2018.
#
...
project = u'GPUPerfAPI'
copyright = u'2018 Advanced Micro Devices, Inc. All rights reserved'
...
htmlhelp_basename = 'GPUPerfAPIdoc'
...
latex_documents = [
    (master_doc, 'GPUPerfAPI.tex', u'GPUPerfAPI Documentation',
...
man_pages = [
    (master_doc, 'gpuperfapi', u'GPUPerfAPI Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'GPUPerfAPI', u'GPUPerfAPI Documentation',
     author, 'GPUPerfAPI', 'One line description of project.',
     'Miscellaneous'),
]
...
spelling_word_list_filename='gpa-wordlist.txt'
