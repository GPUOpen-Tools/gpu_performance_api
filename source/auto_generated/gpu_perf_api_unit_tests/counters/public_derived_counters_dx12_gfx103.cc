...
const GpaCounterDesc kDx12Gfx103PublicCounters[kDx12Gfx103PublicCounterCount] = {
    ...
    true,
    false,
    {0x9f5e6407, 0x3b8c, 0xe0a8, {0x99, 0x87, 0xa5, 0x95, 0x86, 0xb4, 0x5e, 0xa8}}},
    ...
    {// Discrete Counter Index: 30; Streaming Counter Index: 15
    ...
    {// Discrete Counter Index: 31; Streaming Counter Index: 16
    ...
    {// Discrete Counter Index: 32; Streaming Counter Index: 17
    "PreTessVALUBusy",
    "PreTessellation",
    ...
    {// Discrete Counter Index: 33; Streaming Counter Index: 18
    ...
    {// Discrete Counter Index: 34; Streaming Counter Index: 19
    "PreTessSALUBusy",
    "PreTessellation",
    ...
    {// Discrete Counter Index: 35; Streaming Counter Index: 20
    ...
    {// Discrete Counter Index: 36; Streaming Counter Index: 21
    "PreTessVerticesIn",
    "PreTessellation",
    ...
    {// Discrete Counter Index: 37; Streaming Counter Index: 22
    "PostTessPrimsOut",
    "PostTessellation",
    ...
    {// Discrete Counter Index: 38; Streaming Counter Index: 23
    ...
    {// Discrete Counter Index: 40; Streaming Counter Index: 24
    "PostTessVALUBusy",
    "PostTessellation",
    ...
    {// Discrete Counter Index: 41; Streaming Counter Index: 25
    ...
    {// Discrete Counter Index: 42; Streaming Counter Index: 26
    "PostTessSALUBusy",
    "PostTessellation",
    ...
    {// Discrete Counter Index: 43; Streaming Counter Index: 27
    ...
    {// Discrete Counter Index: 46; Streaming Counter Index: 28
    "PrimitivesIn",
    "PrimitiveAssembly",
    ...
    {// Discrete Counter Index: 48; Streaming Counter Index: 29
    "ClippedPrims",
    "PrimitiveAssembly",
    ...
    {// Discrete Counter Index: 49; Streaming Counter Index: 30
    ...
    {// Discrete Counter Index: 50; Streaming Counter Index: 31
    ...
    {// Discrete Counter Index: 51; Streaming Counter Index: 32
    "PSPixelsOut",
    "PixelShader",
    ...
    {// Discrete Counter Index: 52; Streaming Counter Index: 33
    "PSExportStalls",
    "PixelShader",
    ...
    {// Discrete Counter Index: 53; Streaming Counter Index: 34
    ...
    {// Discrete Counter Index: 54; Streaming Counter Index: 35
    ...
    {// Discrete Counter Index: 55; Streaming Counter Index: 36
    ...
    {// Discrete Counter Index: 56; Streaming Counter Index: 37
    "CSThreadsLaunched",
    "ComputeShader",
    ...
    {// Discrete Counter Index: 68; Streaming Counter Index: 39
    "CSLDSBankConflict",
    "ComputeShader",
    ...
    {// Discrete Counter Index: 69; Streaming Counter Index: 40
    ...
    {// Discrete Counter Index: 70; Streaming Counter Index: 41
    "TexUnitBusy",
    "Timing",
    ...
    {// Discrete Counter Index: 71; Streaming Counter Index: 42
    "TexUnitBusyCycles",
    "Timing",
    ...
    {// Discrete Counter Index: 72; Streaming Counter Index: 43
    "TexTriFilteringPct",
    "TextureUnit",
    ...
    {// Discrete Counter Index: 73; Streaming Counter Index: 44
    ...
    {// Discrete Counter Index: 74; Streaming Counter Index: 45
    ...
    {// Discrete Counter Index: 75; Streaming Counter Index: 46
    "TexVolFilteringPct",
    "TextureUnit",
    ...
    {// Discrete Counter Index: 76; Streaming Counter Index: 47
    ...
    {// Discrete Counter Index: 77; Streaming Counter Index: 48
    ...
    {// Discrete Counter Index: 79; Streaming Counter Index: 49
    ...
    {// Discrete Counter Index: 80; Streaming Counter Index: 50
    ...
    {// Discrete Counter Index: 81; Streaming Counter Index: 51
    "HiZTilesAccepted",
    "DepthAndStencil",
    ...
    {// Discrete Counter Index: 82; Streaming Counter Index: 52
    ...
    {// Discrete Counter Index: 83; Streaming Counter Index: 53
    ...
    {// Discrete Counter Index: 84; Streaming Counter Index: 54
    ...
    {// Discrete Counter Index: 85; Streaming Counter Index: 55
    ...
    {// Discrete Counter Index: 86; Streaming Counter Index: 56
    ...
    {// Discrete Counter Index: 89; Streaming Counter Index: 57
    ...
    {// Discrete Counter Index: 94; Streaming Counter Index: 58
    "PostZQuadCount",
    "DepthAndStencil",
    ...
    {// Discrete Counter Index: 95; Streaming Counter Index: 59
    "PreZSamplesPassing",
    "DepthAndStencil",
    ...
    {// Discrete Counter Index: 96; Streaming Counter Index: 60
    "PreZSamplesFailingS",
    "DepthAndStencil",
    ...
    {// Discrete Counter Index: 97; Streaming Counter Index: 61
    "PreZSamplesFailingZ",
    "DepthAndStencil",
    ...
    {// Discrete Counter Index: 98; Streaming Counter Index: 62
    "PostZSamplesPassing",
    "DepthAndStencil",
    ...
    {// Discrete Counter Index: 99; Streaming Counter Index: 63
    ...
    {// Discrete Counter Index: 100; Streaming Counter Index: 64
    ...
    {// Discrete Counter Index: 101; Streaming Counter Index: 65
    "ZUnitStalled",
    "DepthAndStencil",
    ...
    {// Discrete Counter Index: 102; Streaming Counter Index: 66
    "ZUnitStalledCycles",
    "DepthAndStencil",
    ...
    {// Discrete Counter Index: 103; Streaming Counter Index: 67
    "DBMemRead",
    "DepthAndStencil",
    ...
    {// Discrete Counter Index: 104; Streaming Counter Index: 68
    "DBMemWritten",
    "DepthAndStencil",
    ...
    {// Discrete Counter Index: 105; Streaming Counter Index: 69
    "CBMemRead",
    "ColorBuffer",
    ...
    {// Discrete Counter Index: 106; Streaming Counter Index: 70
    "CBColorAndMaskRead",
    "ColorBuffer",
    ...
    {// Discrete Counter Index: 107; Streaming Counter Index: 71
    "CBMemWritten",
    "ColorBuffer",
    ...
    {// Discrete Counter Index: 108; Streaming Counter Index: 72
    ...
    {// Discrete Counter Index: 109; Streaming Counter Index: 73
    "CBSlowPixelPct",
    "ColorBuffer",
    ...
    {// Discrete Counter Index: 110; Streaming Counter Index: 74
    "CBSlowPixelCount",
    "ColorBuffer",
    ...
    {// Discrete Counter Index: 111; Streaming Counter Index: 75
    "L0CacheHit",
    "MemoryCache",
    ...
    {// Discrete Counter Index: 112; Streaming Counter Index: 76
    "L0CacheRequestCount",
    "MemoryCache",
    ...
    {// Discrete Counter Index: 113; Streaming Counter Index: 77
    "L0CacheHitCount",
    "MemoryCache",
    ...
    {// Discrete Counter Index: 114; Streaming Counter Index: 78
    "L0CacheMissCount",
    "MemoryCache",
    ...
    {// Discrete Counter Index: 115; Streaming Counter Index: 79
    "ScalarCacheHit",
    "MemoryCache",
    ...
    {// Discrete Counter Index: 116; Streaming Counter Index: 80
    ...
    {// Discrete Counter Index: 117; Streaming Counter Index: 81
    "ScalarCacheHitCount",
    "MemoryCache",
    ...
    {// Discrete Counter Index: 118; Streaming Counter Index: 82
    ...
    {// Discrete Counter Index: 119; Streaming Counter Index: 83
    "InstCacheHit",
    "MemoryCache",
    ...
    {// Discrete Counter Index: 120; Streaming Counter Index: 84
    ...
    {// Discrete Counter Index: 121; Streaming Counter Index: 85
    "InstCacheHitCount",
    "MemoryCache",
    ...
    {// Discrete Counter Index: 122; Streaming Counter Index: 86
    "InstCacheMissCount",
    "MemoryCache",
    ...
    {// Discrete Counter Index: 123; Streaming Counter Index: 87
    "L1CacheHit",
    "MemoryCache",
    ...
    {// Discrete Counter Index: 125; Streaming Counter Index: 88
    "L1CacheHitCount",
    "MemoryCache",
    ...
    {// Discrete Counter Index: 126; Streaming Counter Index: 89
    "L1CacheMissCount",
    "MemoryCache",
    ...
    {// Discrete Counter Index: 127; Streaming Counter Index: 90
    "L2CacheHit",
    "MemoryCache",
    ...
    {// Discrete Counter Index: 128; Streaming Counter Index: 91
    "L2CacheMiss",
    "MemoryCache",
    ...
    {// Discrete Counter Index: 129; Streaming Counter Index: 92
    "L2CacheRequestCount",
    "MemoryCache",
    ...
    {// Discrete Counter Index: 130; Streaming Counter Index: 93
    "L2CacheHitCount",
    "MemoryCache",
    ...
    {// Discrete Counter Index: 131; Streaming Counter Index: 94
    "L2CacheMissCount",
    "MemoryCache",
    ...
    {// Discrete Counter Index: 132; Streaming Counter Index: 95
    ...
    {// Discrete Counter Index: 133; Streaming Counter Index: 96
    ...
    {// Discrete Counter Index: 134; Streaming Counter Index: 97
    ...
    {// Discrete Counter Index: 135; Streaming Counter Index: 98
    "FetchSize",
    "GlobalMemory",
    ...
    {// Discrete Counter Index: 136; Streaming Counter Index: 99
    "WriteSize",
    "GlobalMemory",
    ...
    {// Discrete Counter Index: 137; Streaming Counter Index: 100
    "MemUnitBusy",
    "GlobalMemory",
    ...
    {// Discrete Counter Index: 138; Streaming Counter Index: 101
    "MemUnitBusyCycles",
    "GlobalMemory",
    ...
    {// Discrete Counter Index: 139; Streaming Counter Index: 102
    "MemUnitStalled",
    "GlobalMemory",
    ...
    {// Discrete Counter Index: 140; Streaming Counter Index: 103
    ...
    {// Discrete Counter Index: 141; Streaming Counter Index: 104
    "WriteUnitStalled",
    "GlobalMemory",
    ...
    {// Discrete Counter Index: 142; Streaming Counter Index: 105
    ...
    {// Discrete Counter Index: 145; Streaming Counter Index: 106
    "RayTriTests",
    "RayTracing",
    ...
    {// Discrete Counter Index: 146; Streaming Counter Index: 107
    "RayBoxTests",
    "RayTracing",
    ...
    {// Discrete Counter Index: 147; Streaming Counter Index: 108
    "TotalRayTests",
    "RayTracing",
    ...
    {// Discrete Counter Index: 148; Streaming Counter Index: 109
    "RayTestsPerWave",
    "RayTracing",
    ...
    false,
    true,
    {0xeb057dbb, 0xdb3b, 0x7cff, {0x8c, 0xb7, 0xe7, 0xd5, 0x67, 0x85, 0x9a, 0x71}}},
    {// Streaming Counter Index: 112
    "LSHSLimitedByLds",
    "WaveOccupancyLimiters",
    ...
    false,
    true,
    {0xcbf8280f, 0xb918, 0x8035, {0xa4, 0x8f, 0xc1, 0x7d, 0xb2, 0xd7, 0x71, 0x9c}}},
    {// Streaming Counter Index: 113
    "LSHSLimitedByScratch",
    "WaveOccupancyLimiters",
    ...
    false,
    true,
    {0xfe374a4e, 0x6034, 0xe9b6, {0xc4, 0xad, 0x6c, 0xd1, 0xe0, 0x25, 0x76, 0x54}}},
    {// Streaming Counter Index: 114
    "HSLimitedByBarriers",
    "WaveOccupancyLimiters",
    ...
    false,
    true,
    {0x5276ed38, 0x4c29, 0x3d43, {0x46, 0xce, 0x10, 0x87, 0x3b, 0x4f, 0x9f, 0xe4}}},
    {// Streaming Counter Index: 116
    "ESGSLimitedByLds",
    "WaveOccupancyLimiters",
    ...
    false,
    true,
    {0x8dd8e95f, 0xfc8e, 0xa976, {0x9a, 0xcc, 0x8d, 0x84, 0x51, 0xeb, 0x76, 0x2f}}},
    {// Streaming Counter Index: 117
    "ESGSLimitedByScratch",
    "WaveOccupancyLimiters",
    ...
    false,
    true,
    {0xeb7c04c4, 0x0a0b, 0x57f5, {0x5e, 0xa7, 0xf1, 0x44, 0x55, 0x0f, 0x52, 0xb0}}},
    {// Streaming Counter Index: 118
    "VSLimitedByVgpr",
    "WaveOccupancyLimiters",
    ...
    false,
    true,
    {0xa05c9f87, 0x3381, 0xd2bb, {0xf7, 0xcd, 0xc7, 0xb7, 0x17, 0xcd, 0xa3, 0x21}}},
    {// Streaming Counter Index: 119
    "VSLimitedByScratch",
    "WaveOccupancyLimiters",
    ...
    false,
    true,
    {0x0811591e, 0x7c8a, 0x4930, {0x84, 0xee, 0xe6, 0x75, 0x05, 0x3a, 0xad, 0x10}}},
    {// Streaming Counter Index: 120
    "VSLimitedByExport",
    "WaveOccupancyLimiters",
    ...
    false,
    true,
    {0x3671cdd8, 0x5f82, 0xf2d0, {0xf2, 0x29, 0xa6, 0x11, 0xaf, 0x36, 0x08, 0x30}}},
    {// Streaming Counter Index: 121
    "PSLimitedByLds",
    "WaveOccupancyLimiters",
