...
#include "public_derived_counters_cl_gfx10.h"

const GPACounterDesc CLGFX10_PUBLIC_COUNTERS[CLGFX10_PUBLIC_COUNTER_COUNT] = {
    ...
    {"L0CacheHit", "GlobalMemory", "The percentage of fetch, write, atomic, and other instructions that hit the data in L0 cache. Value range: 0% (no hit) to 100% (optimal).", GPA_DATA_TYPE_FLOAT64, GPA_USAGE_TYPE_PERCENTAGE, {0xbe1e0578, 0x82b8, 0xad7f, {0xba, 0x3f, 0x3a, 0xfc, 0xe1, 0x50, 0x93, 0x7a}}},
    {"L1CacheHit", "GlobalMemory", "The percentage of fetch, write, atomic, and other instructions that hit the data in L1 cache. Writes and atomics always miss this cache. Value range: 0% (no hit) to 100% (optimal).", GPA_DATA_TYPE_FLOAT64, GPA_USAGE_TYPE_PERCENTAGE, {0xb10c589c, 0xf7a5, 0xb8f2, {0x46, 0xc2, 0xe0, 0xae, 0xd4, 0xa8, 0x41, 0x05}}},
