...
{
    std::vector<GpaHardwareCounterDesc> kVgt0CountersGfx8_tonga = {
    ...
    std::vector<GpaHardwareCounterDesc> kVgt1CountersGfx8_tonga = {
    ...
    std::vector<GpaHardwareCounterDesc> kVgt2CountersGfx8_tonga = {
    ...
    std::vector<GpaHardwareCounterDesc> kVgt3CountersGfx8_tonga = {
