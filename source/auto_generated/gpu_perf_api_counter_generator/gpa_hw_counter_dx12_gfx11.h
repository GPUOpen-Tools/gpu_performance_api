...
{
    extern const gpa_array_view<gpa_array_view<GpaHardwareCounterDesc>> kDx12CounterGroupArrayGfx11; ///< Array of hardware counter groups for Dx12 for Gfx11 family
    extern const gpa_array_view<GpaCounterGroupDesc>                    kHwDx12GroupsGfx11; ///< Array of counter groups for Dx12 for Gfx11 family
    ...
    extern AmdExtGpuBlock                                               kHwDx12DriverBlockIdGfx11[]; ///< Array of driver enum values per group for Dx12 for Gfx11 family
    ...
    extern const std::set<unsigned int>                                 kHwDx12LevelWavesCountersGfx11; ///< The LEVEL_WAVES counters for Dx12 for Gfx11 family.
