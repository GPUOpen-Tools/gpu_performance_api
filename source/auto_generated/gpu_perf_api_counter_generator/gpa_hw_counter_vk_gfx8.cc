...
namespace counter_vk_gfx8
{
    ...
    GpaHardwareCounterDesc* kVkCounterGroupArrayGfx8[] = {
        kCpfCountersGfx8,
        kIa0CountersGfx8,
        kIa1CountersGfx8,
        kVgt0CountersGfx8,
    ...
    GpaHardwareCounterDesc* kVkExposedCountersGroupArrayGfx8[] = {
    ...
    GpaCounterGroupDesc kHwVkGroupsGfx8[] = {
        {0, "CPF", 0, 19, 2, 0},
        {1, "IA0", 0, 24, 4, 0},
        {2, "IA1", 1, 24, 4, 0},
        {3, "VGT0", 0, 147, 4, 0},
    ...
    const unsigned int           kHwVkGroupCountGfx8                = sizeof(kHwVkGroupsGfx8) / sizeof(GpaCounterGroupDesc);
