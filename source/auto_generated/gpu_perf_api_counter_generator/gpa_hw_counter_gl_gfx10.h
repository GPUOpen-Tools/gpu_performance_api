...
{
    extern std::vector<std::vector<GpaHardwareCounterDesc>*>          kGlCounterGroupArrayGfx10; ///< Array of hardware counter groups for Gl for Gfx10 family
    extern std::vector<GpaCounterGroupDesc>                           kHwGlGroupsGfx10; ///< Array of counter groups for Gl for Gfx10 family
    ...
    extern const unsigned int                                         kHwGlExposedCountersGroupCountGfx10; ///< Exposed hardware counter Group Count for Gl for Gfx10 family
