...
{
    extern std::vector<std::vector<GpaHardwareCounterDesc>*>          kGlExposedCountersGroupArrayGfx10; ///< Array of hardware exposed counter groups for Gl for Gfx10 family
