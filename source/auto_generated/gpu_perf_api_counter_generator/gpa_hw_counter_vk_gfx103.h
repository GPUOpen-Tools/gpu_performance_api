...
{
    extern std::vector<std::vector<GpaHardwareCounterDesc>*>          kVkExposedCountersGroupArrayGfx103; ///< Array of hardware exposed counter groups for Vk for Gfx103 family
