...
{
    extern const gpa_array_view<gpa_array_view<GpaHardwareCounterDesc>> kVkCounterGroupArrayGfx103; ///< Array of hardware counter groups for Vk for Gfx103 family
    extern const gpa_array_view<GpaCounterGroupDesc>                    kHwVkGroupsGfx103; ///< Array of counter groups for Vk for Gfx103 family
    ...
    extern VkGpaPerfBlockAMD                                            kHwVkDriverBlockIdGfx103[]; ///< Array of driver enum values per group for Vk for Gfx103 family
