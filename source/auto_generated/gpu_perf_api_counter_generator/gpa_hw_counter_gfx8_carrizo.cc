...
{
    std::vector<GpaHardwareCounterDesc> kVgt0CountersGfx8_carrizo = {
    ...
    std::vector<GpaHardwareCounterDesc> kVgt1CountersGfx8_carrizo = {
    ...
    std::vector<GpaHardwareCounterDesc> kVgt2CountersGfx8_carrizo = {
    ...
    std::vector<GpaHardwareCounterDesc> kVgt3CountersGfx8_carrizo = {
