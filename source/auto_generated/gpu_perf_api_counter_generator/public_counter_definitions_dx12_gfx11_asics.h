...
#ifndef GPA_AUTO_GEN_COUNTER_GEN_PUBLIC_COUNTER_DEFINITIONS_DX12_GFX11_ASICS_H_
#define GPA_AUTO_GEN_COUNTER_GEN_PUBLIC_COUNTER_DEFINITIONS_DX12_GFX11_ASICS_H_
...
namespace dx12_gfx11_asics
{
    ...
    inline void UpdatePublicAsicSpecificCounters(GDT_HW_GENERATION desired_generation, GDT_HW_ASIC_TYPE asic_type, GpaDerivedCounters& c)
    {
        ...
        if (dx12_gfx11_gfx1102::UpdatePublicAsicSpecificCounters(desired_generation, asic_type, c))
        {
            return;
        }
