...
{
    extern const gpa_array_view<gpa_array_view<GpaHardwareCounterDesc>> kVkCounterGroupArrayGfx11; ///< Array of hardware counter groups for Vk for Gfx11 family
    extern const gpa_array_view<GpaCounterGroupDesc>                    kHwVkGroupsGfx11; ///< Array of counter groups for Vk for Gfx11 family
    ...
    extern VkGpaPerfBlockAMD                                            kHwVkDriverBlockIdGfx11[]; ///< Array of driver enum values per group for Vk for Gfx11 family
