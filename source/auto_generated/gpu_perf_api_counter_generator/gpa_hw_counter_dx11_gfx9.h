...
{
    extern std::vector<std::vector<GpaHardwareCounterDesc>*>          kDx11ExposedCountersGroupArrayGfx9; ///< Array of hardware exposed counter groups for Dx11 for Gfx9 family
