...
namespace counter_dx12_gfx10
{
    ...
    const unsigned int hw_dx12_gputimebottomtobottomduration_index_gfx10 = 59893; ///< Index of delta between the previous command reaching bottom of pipe and the current command reaching bottom of pipe, will not include latency of first data to travel through pipeline, best for large data sets. for dx12 for gfx10 family
    const unsigned int hw_dx12_gputimebottomtobottomstart_index_gfx10 = 59894; ///< Index of time of the previous command reaching bottom of pipe for dx12 for gfx10 family
    const unsigned int hw_dx12_gputimebottomtobottomend_index_gfx10 = 59895; ///< Index of time of the current command reaching bottom of pipe for dx12 for gfx10 family
    const unsigned int hw_dx12_gputimetoptobottomduration_index_gfx10 = 59896; ///< Index of execution duration of the current command from top of pipe to bottom of pipe, may include overhead of time in queue for dx12 for gfx10 family
    const unsigned int hw_dx12_gputimetoptobottomstart_index_gfx10 = 59897; ///< Index of time that the current command reaches the top of pipe for dx12 for gfx10 family
    const unsigned int hw_dx12_gputimetoptobottomend_index_gfx10 = 59898; ///< Index of time that the current command reaches the bottom of pipe for dx12 for gfx10 family
    const std::set<unsigned int> hw_dx12_timestamp_block_ids_gfx10 =       {334}; ///< Timestamp block id's for DX12 for gfx10 family
    const std::set<unsigned int> hw_dx12_time_counter_indices_gfx10 =      {59893, 59894, 59895, 59896, 59897, 59898}; ///< Timestamp counter indices for DX12 for gfx10 family
    const unsigned int           hw_dx12_group_count_gfx10                = sizeof(hw_dx12_groups_gfx10) / sizeof(GPA_CounterGroupDesc);
    const unsigned int           hw_dx12_exposed_counters_group_count_gfx10 = 206;
