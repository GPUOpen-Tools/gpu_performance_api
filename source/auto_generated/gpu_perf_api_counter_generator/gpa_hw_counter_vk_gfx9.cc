...
namespace counter_vk_gfx9
{
    ...
    std::vector<std::vector<GpaHardwareCounterDesc>*> kVkExposedCountersGroupArrayGfx9 = {
    ...
    std::vector<GpaCounterGroupDesc> kHwVkGroupsGfx9 = {
        {0, "CPF", 0, 32, 2, 0},
        {1, "IA0", 0, 32, 4, 0},
        {2, "IA1", 1, 32, 4, 0},
        {3, "VGT0", 0, 148, 4, 0},
    ...
    const unsigned int           kHwVkGroupCountGfx9                = static_cast<unsigned int>(kHwVkGroupsGfx9.size());
