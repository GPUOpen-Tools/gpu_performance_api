...
namespace counter_vk_gfx9
{
    ...
    GpaHardwareCounterDesc* kVkCounterGroupArrayGfx9[] = {
        kCpfCountersGfx9,
        kIa0CountersGfx9,
        kIa1CountersGfx9,
        kVgt0CountersGfx9,
    ...
    GpaHardwareCounterDesc* kVkExposedCountersGroupArrayGfx9[] = {
    ...
    GpaCounterGroupDesc kHwVkGroupsGfx9[] = {
        {0, "CPF", 0, 32, 2, 0},
        {1, "IA0", 0, 32, 4, 0},
        {2, "IA1", 1, 32, 4, 0},
        {3, "VGT0", 0, 148, 4, 0},
    ...
    GpaCounterGroupExposedCounterDesc kHwVkExposedCountersByGroupGfx9[] = {
        {0, 0, {0, 23}},
    ...
    GpaPaddedCounterDesc kVkPaddedCounterByGroupGfx9[] = {
    ...
    GpaSqCounterGroupDesc kHwVkSqGroupsGfx9[] = {
        {19, 0, kSqAll},
        {20, 1, kSqAll},
        {21, 2, kSqAll},
        {22, 3, kSqAll},
    ...
    unsigned int kHwVkSqIsolatedGroupsGfx9[] = {
        55, // Ta
        56, // Ta
        57, // Ta
        58, // Ta
    ...
    VkGpaPerfBlockAMD kHwVkDriverEnumGfx9[] = {
    ...
    const unsigned int kHwVkGpuTimeBottomToBottomDurationIndexGfx9 = 57999; ///< Index of delta between the previous command reaching bottom of pipe and the current command reaching bottom of pipe, will not include latency of first data to travel through pipeline, best for large data sets. for Vk for Gfx9 family
    const unsigned int kHwVkGpuTimeBottomToBottomStartIndexGfx9 = 58000; ///< Index of time of the previous command reaching bottom of pipe for Vk for Gfx9 family
    const unsigned int kHwVkGpuTimeBottomToBottomEndIndexGfx9 = 58001; ///< Index of time of the current command reaching bottom of pipe for Vk for Gfx9 family
    const unsigned int kHwVkGpuTimeTopToBottomDurationIndexGfx9 = 58002; ///< Index of execution duration of the current command from top of pipe to bottom of pipe, may include overhead of time in queue for Vk for Gfx9 family
    const unsigned int kHwVkGpuTimeTopToBottomStartIndexGfx9 = 58003; ///< Index of time that the current command reaches the top of pipe for Vk for Gfx9 family
    const unsigned int kHwVkGpuTimeTopToBottomEndIndexGfx9 = 58004; ///< Index of time that the current command reaches the bottom of pipe for Vk for Gfx9 family
    const std::set<unsigned int> kHwVkTimestampBlockIdsGfx9 =       {385}; ///< Timestamp block id's for VK for gfx9 family
    const std::set<unsigned int> kHwVkTimeCounterIndicesGfx9 =      {57999, 58000, 58001, 58002, 58003, 58004}; ///< Timestamp counter indices for VK for gfx9 family
    const unsigned int           kHwVkGroupCountGfx9                = sizeof(kHwVkGroupsGfx9) / sizeof(GpaCounterGroupDesc);
    const unsigned int           kHwVkExposedCountersGroupCountGfx9 = 263;
    const unsigned int           kVkPaddedCounterGroupCountGfx9 = 73;
    const unsigned int           kHwVkSqGroupCountGfx9              = sizeof(kHwVkSqGroupsGfx9) / sizeof(GpaSqCounterGroupDesc);
    const unsigned int           kHwVkSqIsolatedGroupCountGfx9      = sizeof(kHwVkSqIsolatedGroupsGfx9) / sizeof(unsigned int);
} //  namespace counter_vk_gfx9
