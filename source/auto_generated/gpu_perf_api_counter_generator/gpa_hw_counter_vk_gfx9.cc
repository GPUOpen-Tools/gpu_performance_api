...
{
    GPA_HardwareCounterDesc* vk_counter_group_array_gfx9[] = {
        cpf_counters_gfx9,
        ia0_counters_gfx9,
        ia1_counters_gfx9,
        vgt0_counters_gfx9,
    ...
    GPA_HardwareCounterDesc* vk_exposed_counters_group_array_gfx9[] = {
    ...
    GPA_CounterGroupDesc hw_vk_groups_gfx9[] = {
        {0, "CPF", 0, 32, 2, 4},
        {1, "IA0", 0, 32, 4, 4},
        {2, "IA1", 1, 32, 4, 4},
        {3, "VGT0", 0, 148, 4, 5},
    ...
    GPA_CounterGroupExposedCounterDesc hw_vk_exposed_counters_by_group_gfx9[] = {
        {0, 0, {0, 23}},
    ...
    GPA_PaddedCounterDesc vk_padded_counter_by_group_gfx9[] = {
    ...
    GPA_SQCounterGroupDesc hw_vk_sq_groups_gfx9[] = {
        {19, 0, SQ_ALL},
        {20, 1, SQ_ALL},
        {21, 2, SQ_ALL},
        {22, 3, SQ_ALL},
    ...
    unsigned int hw_vk_sq_isolated_groups_gfx9[] = {
        55, // Ta
        56, // Ta
        57, // Ta
        58, // Ta
    ...
    VkGpaPerfBlockAMD hw_vk_driver_enum_gfx9[] = {
    ...
    const unsigned int hw_vk_gputimebottomtobottomduration_index_gfx9 = 56671; ///< Index of delta between the previous command reaching bottom of pipe and the current command reaching bottom of pipe, will not include latency of first data to travel through pipeline, best for large data sets. for vk for gfx9 family
    const unsigned int hw_vk_gputimebottomtobottomstart_index_gfx9 = 56672; ///< Index of time of the previous command reaching bottom of pipe for vk for gfx9 family
    const unsigned int hw_vk_gputimebottomtobottomend_index_gfx9 = 56673; ///< Index of time of the current command reaching bottom of pipe for vk for gfx9 family
    const unsigned int hw_vk_gputimetoptobottomduration_index_gfx9 = 56674; ///< Index of execution duration of the current command from top of pipe to bottom of pipe, may include overhead of time in queue for vk for gfx9 family
    const unsigned int hw_vk_gputimetoptobottomstart_index_gfx9 = 56675; ///< Index of time that the current command reaches the top of pipe for vk for gfx9 family
    const unsigned int hw_vk_gputimetoptobottomend_index_gfx9 = 56676; ///< Index of time that the current command reaches the bottom of pipe for vk for gfx9 family
    const std::set<unsigned int> hw_vk_timestamp_block_ids_gfx9 =       {369}; ///< Timestamp block id's for VK for gfx9 family
    const std::set<unsigned int> hw_vk_time_counter_indices_gfx9 =      {56671, 56672, 56673, 56674, 56675, 56676}; ///< Timestamp counter indices for VK for gfx9 family
    const unsigned int           hw_vk_group_count_gfx9                = sizeof(hw_vk_groups_gfx9) / sizeof(GPA_CounterGroupDesc);
    const unsigned int           hw_vk_exposed_counters_group_count_gfx9 = 247;
    const unsigned int           vk_padded_counter_group_count_gfx9 = 57;
    const unsigned int           hw_vk_sq_group_count_gfx9              = sizeof(hw_vk_sq_groups_gfx9) / sizeof(GPA_SQCounterGroupDesc);
    const unsigned int           hw_vk_sq_isolated_group_count_gfx9      = sizeof(hw_vk_sq_isolated_groups_gfx9) / sizeof(unsigned int);
}; // namespace
