...
namespace counter_vk_gfx9
{
    ...
    const unsigned int kHwVkGpuTimeBottomToBottomDurationIndexGfx9 = 56671; ///< Index of delta between the previous command reaching bottom of pipe and the current command reaching bottom of pipe, will not include latency of first data to travel through pipeline, best for large data sets. for Vk for Gfx9 family
    const unsigned int kHwVkGpuTimeBottomToBottomStartIndexGfx9 = 56672; ///< Index of time of the previous command reaching bottom of pipe for Vk for Gfx9 family
    const unsigned int kHwVkGpuTimeBottomToBottomEndIndexGfx9 = 56673; ///< Index of time of the current command reaching bottom of pipe for Vk for Gfx9 family
    const unsigned int kHwVkGpuTimeTopToBottomDurationIndexGfx9 = 56674; ///< Index of execution duration of the current command from top of pipe to bottom of pipe, may include overhead of time in queue for Vk for Gfx9 family
    const unsigned int kHwVkGpuTimeTopToBottomStartIndexGfx9 = 56675; ///< Index of time that the current command reaches the top of pipe for Vk for Gfx9 family
    const unsigned int kHwVkGpuTimeTopToBottomEndIndexGfx9 = 56676; ///< Index of time that the current command reaches the bottom of pipe for Vk for Gfx9 family
    const std::set<unsigned int> kHwVkTimestampBlockIdsGfx9 =       {369}; ///< Timestamp block id's for VK for gfx9 family
    const std::set<unsigned int> kHwVkTimeCounterIndicesGfx9 =      {56671, 56672, 56673, 56674, 56675, 56676}; ///< Timestamp counter indices for VK for gfx9 family
    const unsigned int           kHwVkGroupCountGfx9                = sizeof(kHwVkGroupsGfx9) / sizeof(GpaCounterGroupDesc);
    const unsigned int           kHwVkExposedCountersGroupCountGfx9 = 247;
    const unsigned int           kVkPaddedCounterGroupCountGfx9 = 57;
