...
#include "auto_generated/gpu_perf_api_counter_generator/public_counter_definitions_cl_gfx103_gfx1033.h"
...
namespace cl_gfx103_asics
{
    ...
    inline void UpdatePublicAsicSpecificCounters(GDT_HW_GENERATION desired_generation, GDT_HW_ASIC_TYPE asic_type, GpaDerivedCounters& c)
    {
        ...
        if (cl_gfx103_gfx1033::UpdatePublicAsicSpecificCounters(desired_generation, asic_type, c))
        {
            return;
        }
