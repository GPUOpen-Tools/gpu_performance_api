...
namespace counter_gl_gfx8
{
    ...
    GPA_HardwareCounterDesc* gl_counter_group_array_gfx8[] = {
        cb0_counters_gfx8,
        cb1_counters_gfx8,
        cb2_counters_gfx8,
        cb3_counters_gfx8,
    ...
    GPA_HardwareCounterDesc* gl_exposed_counters_group_array_gfx8[] = {
    ...
    GPA_CounterGroupDesc hw_gl_groups_gfx8[] = {
        {0, "CB0", 0, 396, 4, 0},
        {1, "CB1", 1, 396, 4, 0},
        {2, "CB2", 2, 396, 4, 0},
        {3, "CB3", 3, 396, 4, 0},
    ...
    GPA_CounterGroupExposedCounterDesc hw_gl_exposed_counters_by_group_gfx8[] = {
    ...
    GPA_PaddedCounterDesc gl_padded_counter_by_group_gfx8[] = {
    {}
    };

    GPA_SQCounterGroupDesc hw_gl_sq_groups_gfx8[] = {
        {14, 0, SQ_ALL},
        {15, 0, SQ_ES},
        {16, 0, SQ_GS},
        {17, 0, SQ_VS},
    ...
    unsigned int hw_gl_sq_isolated_groups_gfx8[] = {
        23, // Ta
        24, // Ta
        25, // Ta
        26, // Ta
    ...
    const unsigned int hw_gl_gputimebottomtobottomduration_index_gfx8 = 15125; ///< Index of delta between the previous command reaching bottom of pipe and the current command reaching bottom of pipe, will not include latency of first data to travel through pipeline, best for large data sets. for gl for gfx8 family
    const unsigned int hw_gl_gputimebottomtobottomstart_index_gfx8 = static_cast<unsigned int>(-1); ///< Index of time of the previous command reaching bottom of pipe for gl for gfx8 family
    const unsigned int hw_gl_gputimebottomtobottomend_index_gfx8 = static_cast<unsigned int>(-1); ///< Index of time of the current command reaching bottom of pipe for gl for gfx8 family
    const unsigned int hw_gl_gputimetoptobottomduration_index_gfx8 = 15128; ///< Index of execution duration of the current command from top of pipe to bottom of pipe, may include overhead of time in queue for gl for gfx8 family
    const unsigned int hw_gl_gputimetoptobottomstart_index_gfx8 = static_cast<unsigned int>(-1); ///< Index of time that the current command reaches the top of pipe for gl for gfx8 family
    const unsigned int hw_gl_gputimetoptobottomend_index_gfx8 = static_cast<unsigned int>(-1); ///< Index of time that the current command reaches the bottom of pipe for gl for gfx8 family
    const std::set<unsigned int> hw_gl_timestamp_block_ids_gfx8 =       {98}; ///< Timestamp block id's for GL for gfx8 family
    const std::set<unsigned int> hw_gl_time_counter_indices_gfx8 =      {15125, 15126, 15127, 15128, 15129, 15130}; ///< Timestamp counter indices for GL for gfx8 family
    const unsigned int           hw_gl_group_count_gfx8                = sizeof(hw_gl_groups_gfx8) / sizeof(GPA_CounterGroupDesc);
    const unsigned int           hw_gl_exposed_counters_group_count_gfx8 = 71;
    const unsigned int           gl_padded_counter_group_count_gfx8 = 0;
    const unsigned int           hw_gl_sq_group_count_gfx8              = sizeof(hw_gl_sq_groups_gfx8) / sizeof(GPA_SQCounterGroupDesc);
    const unsigned int           hw_gl_sq_isolated_group_count_gfx8      = sizeof(hw_gl_sq_isolated_groups_gfx8) / sizeof(unsigned int);
} //  namespace counter_gl_gfx8
