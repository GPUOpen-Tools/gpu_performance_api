...
namespace counter_dx12_gfx8
{
    ...
    std::vector<std::vector<GpaHardwareCounterDesc>*> kDx12ExposedCountersGroupArrayGfx8 = {
    ...
    std::vector<GpaCounterGroupDesc> kHwDx12GroupsGfx8 = {
        {0, "CPF", 0, 19, 2, 0},
        {1, "IA0", 0, 24, 4, 0},
        {2, "IA1", 1, 24, 4, 0},
        {3, "VGT0", 0, 147, 4, 0},
    ...
    const unsigned int           kHwDx12GroupCountGfx8                = static_cast<unsigned int>(kHwDx12GroupsGfx8.size());
