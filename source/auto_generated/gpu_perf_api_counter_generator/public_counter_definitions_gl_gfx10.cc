...
void AutoDefinePublicDerivedCountersGlGfx10(GpaDerivedCounters& c)
{
    ...
    {
        vector<GpaUInt32> internal_counters;
        internal_counters.push_back(15773);
        internal_counters.push_back(1868);
    ...
    {
        vector<GpaUInt32> internal_counters;
        internal_counters.push_back(15801);
    ...
    }
    {
        ...
        c.DefineDerivedCounter("PostTessVALUInstCount", "PostTessellation", "Average number of vector ALU instructions executed for the DS and GS in a pipeline that uses tessellation. Affected by flow control.", kGpaDataTypeFloat64, kGpaUsageTypeItems, internal_counters, "(0),0,1,/,2,ifnotzero", "718b7237-1371-4c85-3ad1-f12af258ba08");
    }
    {
        vector<GpaUInt32> internal_counters;
        ...
        c.DefineDerivedCounter("PostTessSALUInstCount", "PostTessellation", "Average number of scalar ALU instructions executed for the DS and GS in a pipeline that uses tessellation. Affected by flow control.", kGpaDataTypeFloat64, kGpaUsageTypeItems, internal_counters, "(0),0,1,/,2,ifnotzero", "546cecd8-53d4-c7b7-3b2e-f5b2db6c8282");
    }
    {
        vector<GpaUInt32> internal_counters;
    ...
    {
        vector<GpaUInt32> internal_counters;
        internal_counters.push_back(3438);
    ...
    }
    {
        ...
        c.DefineDerivedCounter("CSThreadGroupsLaunched", "ComputeShader", "Total number of thread groups launched.", kGpaDataTypeFloat64, kGpaUsageTypeItems, internal_counters, "0,1,+", "e1e2f302-868a-1d2e-ca81-9901bbc8b58f");
    }
    {
        vector<GpaUInt32> internal_counters;
        internal_counters.push_back(8717);

        c.DefineDerivedCounter("CSWavefrontsLaunched", "ComputeShader", "The total number of wavefronts launched for the CS.", kGpaDataTypeFloat64, kGpaUsageTypeItems, internal_counters, "0", "00c49129-6ae5-f6a0-1753-4738cbe17938");
    }
    {
        vector<GpaUInt32> internal_counters;
        internal_counters.push_back(8721);

        c.DefineDerivedCounter("CSThreadsLaunched", "ComputeShader", "The number of CS threads launched and processed by the hardware.", kGpaDataTypeFloat64, kGpaUsageTypeItems, internal_counters, "0", "cbbbf1ba-d164-1c90-9df0-6120c1660fb1");
    }
    {
        vector<GpaUInt32> internal_counters;
        internal_counters.push_back(8721);
    ...
    }
    {
        ...
        c.DefineDerivedCounter("CSLDSBankConflict", "ComputeShader", "The percentage of GPUTime LDS is stalled by bank conflicts. Value range: 0% (optimal) to 100% (bad).", kGpaDataTypeFloat64, kGpaUsageTypePercentage, internal_counters, "0,NUM_SIMDS,/,1,/,(100),*", "1065ee10-2e41-ea41-1eb3-b61b491752f4");
    }
    {
        vector<GpaUInt32> internal_counters;
        internal_counters.push_back(8998);
    ...
    {
        vector<GpaUInt32> internal_counters;
        internal_counters.push_back(14086);
        internal_counters.push_back(14163);
        internal_counters.push_back(14240);
        internal_counters.push_back(14317);
        internal_counters.push_back(14394);
        internal_counters.push_back(14471);
        internal_counters.push_back(14548);
        internal_counters.push_back(14625);
        internal_counters.push_back(14702);
        internal_counters.push_back(14779);
        internal_counters.push_back(14856);
        internal_counters.push_back(14933);
        internal_counters.push_back(15010);
        internal_counters.push_back(15087);
        internal_counters.push_back(15164);
        internal_counters.push_back(15241);
    ...
    {
        vector<GpaUInt32> internal_counters;
        internal_counters.push_back(14087);
        internal_counters.push_back(14164);
        internal_counters.push_back(14241);
        internal_counters.push_back(14318);
        internal_counters.push_back(14395);
        internal_counters.push_back(14472);
        ...
        internal_counters.push_back(14934);
        internal_counters.push_back(15011);
        internal_counters.push_back(15088);
        internal_counters.push_back(15165);
    ...
    {
        vector<GpaUInt32> internal_counters;
        internal_counters.push_back(14088);
        internal_counters.push_back(14165);
        internal_counters.push_back(14242);
        internal_counters.push_back(14319);
        internal_counters.push_back(14396);
        internal_counters.push_back(14473);
        ...
        internal_counters.push_back(14858);
        internal_counters.push_back(14935);
        internal_counters.push_back(15012);
        internal_counters.push_back(15089);
        internal_counters.push_back(15166);
        internal_counters.push_back(15243);
