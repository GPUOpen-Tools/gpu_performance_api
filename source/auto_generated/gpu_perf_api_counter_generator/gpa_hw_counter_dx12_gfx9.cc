...
namespace counter_dx12_gfx9
{
    ...
    std::vector<std::vector<GpaHardwareCounterDesc>*> kDx12ExposedCountersGroupArrayGfx9 = {
    ...
    std::vector<GpaCounterGroupDesc> kHwDx12GroupsGfx9 = {
        {0, "CPF", 0, 32, 2, 0},
        {1, "IA0", 0, 32, 4, 0},
        {2, "IA1", 1, 32, 4, 0},
        {3, "VGT0", 0, 148, 4, 0},
    ...
    const unsigned int           kHwDx12GroupCountGfx9                = static_cast<unsigned int>(kHwDx12GroupsGfx9.size());
