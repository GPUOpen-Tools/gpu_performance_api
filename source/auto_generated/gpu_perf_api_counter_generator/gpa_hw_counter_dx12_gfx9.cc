...
namespace counter_dx12_gfx9
{
    ...
    const unsigned int kHwDx12GpuTimeBottomToBottomStartIndexGfx9 = 56672; ///< Index of time of the previous command reaching bottom of pipe for Dx12 for Gfx9 family
    const unsigned int kHwDx12GpuTimeBottomToBottomEndIndexGfx9 = 56673; ///< Index of time of the current command reaching bottom of pipe for Dx12 for Gfx9 family
    const unsigned int kHwDx12GpuTimeTopToBottomDurationIndexGfx9 = 56674; ///< Index of execution duration of the current command from top of pipe to bottom of pipe, may include overhead of time in queue for Dx12 for Gfx9 family
    const unsigned int kHwDx12GpuTimeTopToBottomStartIndexGfx9 = 56675; ///< Index of time that the current command reaches the top of pipe for Dx12 for Gfx9 family
    const unsigned int kHwDx12GpuTimeTopToBottomEndIndexGfx9 = 56676; ///< Index of time that the current command reaches the bottom of pipe for Dx12 for Gfx9 family
    const std::set<unsigned int> kHwDx12TimestampBlockIdsGfx9 =       {369}; ///< Timestamp block id's for DX12 for gfx9 family
    const std::set<unsigned int> kHwDx12TimeCounterIndicesGfx9 =      {56671, 56672, 56673, 56674, 56675, 56676}; ///< Timestamp counter indices for DX12 for gfx9 family
    const unsigned int           kHwDx12GroupCountGfx9                = sizeof(kHwDx12GroupsGfx9) / sizeof(GpaCounterGroupDesc);
    const unsigned int           kHwDx12ExposedCountersGroupCountGfx9 = 247;
    const unsigned int           kDx12PaddedCounterGroupCountGfx9 = 57;
