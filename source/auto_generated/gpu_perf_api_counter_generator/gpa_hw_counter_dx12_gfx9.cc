...
namespace counter_dx12_gfx9
{
    ...
    GpaHardwareCounterDesc* kDx12CounterGroupArrayGfx9[] = {
        kCpfCountersGfx9,
        kIa0CountersGfx9,
        kIa1CountersGfx9,
        kVgt0CountersGfx9,
    ...
    GpaHardwareCounterDesc* kDx12ExposedCountersGroupArrayGfx9[] = {
    ...
    GpaCounterGroupDesc kHwDx12GroupsGfx9[] = {
        {0, "CPF", 0, 32, 2, 0},
        {1, "IA0", 0, 32, 4, 0},
        {2, "IA1", 1, 32, 4, 0},
        {3, "VGT0", 0, 148, 4, 0},
    ...
    GpaCounterGroupExposedCounterDesc kHwDx12ExposedCountersByGroupGfx9[] = {
        {0, 0, {0, 23}},
        ...
        {342, 54402, {55, 57}},
        {343, 54485, {55, 57}},
        {385, 57999, {0, 1, 2, 3, 4, 5}},
    };

    GpaPaddedCounterDesc kDx12PaddedCounterByGroupGfx9[] = {
    ...
    GpaSqCounterGroupDesc kHwDx12SqGroupsGfx9[] = {
        {19, 0, kSqAll},
        {20, 1, kSqAll},
        {21, 2, kSqAll},
        {22, 3, kSqAll},
    ...
    unsigned int kHwDx12SqIsolatedGroupsGfx9[] = {
        55, // Ta
        56, // Ta
        57, // Ta
        58, // Ta
    ...
    AmdExtGpuBlock kHwDx12DriverEnumGfx9[] = {
    AmdExtGpuBlock::Cpf,
    AmdExtGpuBlock::Ia,
    AmdExtGpuBlock::Ia,
    AmdExtGpuBlock::Vgt,
    ...
    const unsigned int kHwDx12GpuTimeBottomToBottomDurationIndexGfx9 = 57999; ///< Index of delta between the previous command reaching bottom of pipe and the current command reaching bottom of pipe, will not include latency of first data to travel through pipeline, best for large data sets. for Dx12 for Gfx9 family
    const unsigned int kHwDx12GpuTimeBottomToBottomStartIndexGfx9 = 58000; ///< Index of time of the previous command reaching bottom of pipe for Dx12 for Gfx9 family
    const unsigned int kHwDx12GpuTimeBottomToBottomEndIndexGfx9 = 58001; ///< Index of time of the current command reaching bottom of pipe for Dx12 for Gfx9 family
    const unsigned int kHwDx12GpuTimeTopToBottomDurationIndexGfx9 = 58002; ///< Index of execution duration of the current command from top of pipe to bottom of pipe, may include overhead of time in queue for Dx12 for Gfx9 family
    const unsigned int kHwDx12GpuTimeTopToBottomStartIndexGfx9 = 58003; ///< Index of time that the current command reaches the top of pipe for Dx12 for Gfx9 family
    const unsigned int kHwDx12GpuTimeTopToBottomEndIndexGfx9 = 58004; ///< Index of time that the current command reaches the bottom of pipe for Dx12 for Gfx9 family
    const std::set<unsigned int> kHwDx12TimestampBlockIdsGfx9 =       {385}; ///< Timestamp block id's for DX12 for gfx9 family
    const std::set<unsigned int> kHwDx12TimeCounterIndicesGfx9 =      {57999, 58000, 58001, 58002, 58003, 58004}; ///< Timestamp counter indices for DX12 for gfx9 family
    const unsigned int           kHwDx12GroupCountGfx9                = sizeof(kHwDx12GroupsGfx9) / sizeof(GpaCounterGroupDesc);
    const unsigned int           kHwDx12ExposedCountersGroupCountGfx9 = 263;
    const unsigned int           kDx12PaddedCounterGroupCountGfx9 = 73;
    const unsigned int           kHwDx12SqGroupCountGfx9              = sizeof(kHwDx12SqGroupsGfx9) / sizeof(GpaSqCounterGroupDesc);
    const unsigned int           kHwDx12SqIsolatedGroupCountGfx9      = sizeof(kHwDx12SqIsolatedGroupsGfx9) / sizeof(unsigned int);
} //  namespace counter_dx12_gfx9
