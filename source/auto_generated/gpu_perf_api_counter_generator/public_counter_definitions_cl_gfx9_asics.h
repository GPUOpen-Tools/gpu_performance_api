...
/// \file
/// \brief Public Counter Definitions ASIC file for CLGFX9
//==============================================================================

#ifndef _PUBLIC_COUNTER_DEFINITIONS_CLGFX9_ASICS_H_
#define _PUBLIC_COUNTER_DEFINITIONS_CLGFX9_ASICS_H_
...
namespace clgfx9asics
{
    ...
    {
        if (clgfx9gfx906::UpdatePublicAsicSpecificCounters(desired_generation, asic_type, c))
        {
            return;
        }

        if (clgfx9gfx909::UpdatePublicAsicSpecificCounters(desired_generation, asic_type, c))
        {
            return;
        }

        if (clgfx9placeholder4::UpdatePublicAsicSpecificCounters(desired_generation, asic_type, c))
        {
            return;
        }
    }
...
#endif  // _PUBLIC__COUNTER_DEFINITIONS_CLGFX9_ASICS_H_
