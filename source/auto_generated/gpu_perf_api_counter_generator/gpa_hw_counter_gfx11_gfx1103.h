...
{
    static std::set<GDT_HW_ASIC_TYPE> asics_supported = { GDT_GFX11_0_3, GDT_GFX11_0_3B };
...
#endif  // GPA_AUTO_GENERATED_GPU_PERF_API_COUNTER_GENERATOR_GPA_HW_COUNTER_GFX11_GFX1103_H_
