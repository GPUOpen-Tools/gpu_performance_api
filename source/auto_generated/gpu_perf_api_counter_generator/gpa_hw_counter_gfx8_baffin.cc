...
{
    std::vector<GpaHardwareCounterDesc> kVgt0CountersGfx8_baffin = {
    ...
    std::vector<GpaHardwareCounterDesc> kVgt1CountersGfx8_baffin = {
    ...
    std::vector<GpaHardwareCounterDesc> kVgt2CountersGfx8_baffin = {
    ...
    std::vector<GpaHardwareCounterDesc> kVgt3CountersGfx8_baffin = {
