...
/// \file
/// \brief Public Counter Definitions ASIC file for DX11GFX9
//==============================================================================

#ifndef _PUBLIC_COUNTER_DEFINITIONS_DX11GFX9_ASICS_H_
#define _PUBLIC_COUNTER_DEFINITIONS_DX11GFX9_ASICS_H_
...
namespace dx11gfx9asics
{
    ...
    {
        if (dx11gfx9gfx906::UpdatePublicAsicSpecificCounters(desired_generation, asic_type, c))
        {
            return;
        }

        if (dx11gfx9gfx909::UpdatePublicAsicSpecificCounters(desired_generation, asic_type, c))
        {
            return;
        }

        if (dx11gfx9placeholder4::UpdatePublicAsicSpecificCounters(desired_generation, asic_type, c))
        {
            return;
        }
    }
...
#endif  // _PUBLIC__COUNTER_DEFINITIONS_DX11GFX9_ASICS_H_
