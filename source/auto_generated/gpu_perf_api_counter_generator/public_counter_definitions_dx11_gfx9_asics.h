...
/// @file
/// @brief Public Counter Definitions ASIC file for DX11_GFX9
//==============================================================================

#ifndef GPA_AUTO_GEN_COUNTER_GEN_PUBLIC_COUNTER_DEFINITIONS_DX11_GFX9_ASICS_H_
#define GPA_AUTO_GEN_COUNTER_GEN_PUBLIC_COUNTER_DEFINITIONS_DX11_GFX9_ASICS_H_
...
#include "auto_generated/gpu_perf_api_counter_generator/public_counter_definitions_dx11_gfx9_placeholder4.h"

namespace dx11_gfx9_asics
{
    ...
    inline void UpdatePublicAsicSpecificCounters(GDT_HW_GENERATION desired_generation, GDT_HW_ASIC_TYPE asic_type, GpaDerivedCounters& c)
    {
        ...
        counter_dx11_gfx9::OverrideMaxBlockEvents(asic_type);

        if (dx11_gfx9_gfx906::UpdatePublicAsicSpecificCounters(desired_generation, asic_type, c))
        {
            return;
        }

        if (dx11_gfx9_gfx909::UpdatePublicAsicSpecificCounters(desired_generation, asic_type, c))
        {
            return;
        }

        if (dx11_gfx9_placeholder4::UpdatePublicAsicSpecificCounters(desired_generation, asic_type, c))
        {
            return;
        }
...
}  // namespace dx11_gfx9asics

#endif  // GPA_AUTO_GEN_COUNTER_GEN_PUBLIC_COUNTER_DEFINITIONS_DX11_GFX9_ASICS_H_
