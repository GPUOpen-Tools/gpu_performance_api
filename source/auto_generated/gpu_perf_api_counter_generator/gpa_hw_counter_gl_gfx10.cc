...
namespace countergfx10
{
    ...
    GPA_CounterGroupDesc hw_gl_groups_gfx10[] = {
        ...
        {90, "GL2C8", 8, 235, 4, 8},
        {91, "GL2C9", 9, 235, 4, 8},
        {92, "GL2C10", 10, 235, 4, 8},
        {93, "GL2C11", 11, 235, 4, 8},
        {94, "GL2C12", 12, 235, 4, 8},
        {95, "GL2C13", 13, 235, 4, 8},
        {96, "GL2C14", 14, 235, 4, 8},
        {97, "GL2C15", 15, 235, 4, 8},
        {98, "GL2C16", 16, 235, 4, 8},
        {99, "GL2C17", 17, 235, 4, 8},
        {100, "GL2C18", 18, 235, 4, 8},
        {101, "GL2C19", 19, 235, 4, 8},
        {102, "GL2C20", 20, 235, 4, 8},
        {103, "GL2C21", 21, 235, 4, 8},
        {104, "GL2C22", 22, 235, 4, 8},
        {105, "GL2C23", 23, 235, 4, 8},
        {106, "PA_PH", 0, 960, 8, 16},
        {107, "UTCL1", 0, 15, 2, 0},
        {108, "CHC", 0, 35, 4, 4},
        {109, "CHA", 0, 45, 4, 4},
        {110, "CHCG", 0, 35, 4, 4},
