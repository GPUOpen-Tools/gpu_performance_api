...
/// @file
/// @brief Public Counter Definitions ASIC file for DX12_GFX103
//==============================================================================

#ifndef GPA_AUTO_GEN_COUNTER_GEN_PUBLIC_COUNTER_DEFINITIONS_DX12_GFX103_ASICS_H_
#define GPA_AUTO_GEN_COUNTER_GEN_PUBLIC_COUNTER_DEFINITIONS_DX12_GFX103_ASICS_H_
...
#include "auto_generated/gpu_perf_api_counter_generator/public_counter_definitions_dx12_gfx103_gfx1031_gfx1032.h"
#include "auto_generated/gpu_perf_api_counter_generator/public_counter_definitions_dx12_gfx103_gfx1033.h"

namespace dx12_gfx103_asics
{
    ...
    inline void UpdatePublicAsicSpecificCounters(GDT_HW_GENERATION desired_generation, GDT_HW_ASIC_TYPE asic_type, GpaDerivedCounters& c)
    {
        ...
        counter_dx12_gfx103::OverrideMaxBlockEvents(asic_type);

        if (dx12_gfx103_gfx1031_gfx1032::UpdatePublicAsicSpecificCounters(desired_generation, asic_type, c))
        {
            return;
        }

        if (dx12_gfx103_gfx1033::UpdatePublicAsicSpecificCounters(desired_generation, asic_type, c))
        {
            return;
        }
...
}  // namespace dx12_gfx103asics

#endif  // GPA_AUTO_GEN_COUNTER_GEN_PUBLIC_COUNTER_DEFINITIONS_DX12_GFX103_ASICS_H_
