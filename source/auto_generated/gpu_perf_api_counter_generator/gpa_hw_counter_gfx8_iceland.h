...
inline bool OverrideBlockInstanceCounters(GDT_HW_ASIC_TYPE asic_type)
{
    ...
    ReplaceBlockInstanceCounters(counter_gfx8::vgt0_counters_gfx8, vgt0_counters_gfx8_iceland, 147);
    ReplaceBlockInstanceCounters(counter_gfx8::vgt1_counters_gfx8, vgt1_counters_gfx8_iceland, 147);
    ReplaceBlockInstanceCounters(counter_gfx8::vgt2_counters_gfx8, vgt2_counters_gfx8_iceland, 147);
    ReplaceBlockInstanceCounters(counter_gfx8::vgt3_counters_gfx8, vgt3_counters_gfx8_iceland, 147);
