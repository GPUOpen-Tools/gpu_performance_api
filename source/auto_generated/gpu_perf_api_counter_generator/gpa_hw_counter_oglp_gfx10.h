...
{
    extern std::vector<std::vector<GpaHardwareCounterDesc>*>          kOglpCounterGroupArrayGfx10; ///< Array of hardware counter groups for Oglp for Gfx10 family
    ...
    extern const unsigned int                                         kHwOglpExposedCountersGroupCountGfx10; ///< Exposed hardware counter Group Count for Oglp for Gfx10 family
