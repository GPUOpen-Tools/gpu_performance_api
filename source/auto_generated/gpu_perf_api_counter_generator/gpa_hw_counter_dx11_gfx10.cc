...
namespace counter_dx11_gfx10
{
    ...
    GpaHardwareCounterDesc* kDx11CounterGroupArrayGfx10[] = {
        kCpfCountersGfx10,
        kCb0CountersGfx10,
        kCb1CountersGfx10,
        kCb2CountersGfx10,
        ...
        kGpuTimestampCountersGfx10,
        kGpuTimeCountersGfx10,
    };

    GpaHardwareCounterDesc* kDx11ExposedCountersGroupArrayGfx10[] = {
    ...
    GpaCounterGroupDesc kHwDx11GroupsGfx10[] = {
        {0, "CPF", 0, 40, 2, 0},
        {1, "CB0", 0, 461, 4, 0},
        {2, "CB1", 1, 461, 4, 0},
        {3, "CB2", 2, 461, 4, 0},
    ...
    GpaCounterGroupExposedCounterDesc kHwDx11ExposedCountersByGroupGfx10[] = {
        ...
        {55, 20466, {4, 5, 8, 31, 55, 57, 59, 60, 61, 64, 69, 70, 82, 117, 285, 299, 300, 301, 302, 334, 335, 336, 337}},
        {56, 20978, {4, 5, 8, 31, 55, 57, 59, 60, 61, 64, 69, 70, 82, 117, 285, 299, 300, 301, 302, 334, 335, 336, 337}},
        {57, 21490, {4, 5, 8, 31, 55, 57, 59, 60, 61, 64, 69, 70, 82, 117, 285, 299, 300, 301, 302, 334, 335, 336, 337}},
        {58, 22002, {4, 5, 8, 31, 55, 57, 59, 60, 61, 64, 69, 70, 82, 117, 285, 299, 300, 301, 302, 334, 335, 336, 337}},
        {59, 22514, {4, 5, 8, 31, 55, 57, 59, 60, 61, 64, 69, 70, 82, 117, 285, 299, 300, 301, 302, 334, 335, 336, 337}},
        {60, 23026, {4, 5, 8, 31, 55, 57, 59, 60, 61, 64, 69, 70, 82, 117, 285, 299, 300, 301, 302, 334, 335, 336, 337}},
        {61, 23538, {4, 5, 8, 31, 55, 57, 59, 60, 61, 64, 69, 70, 82, 117, 285, 299, 300, 301, 302, 334, 335, 336, 337}},
        {62, 24050, {4, 5, 8, 31, 55, 57, 59, 60, 61, 64, 69, 70, 82, 117, 285, 299, 300, 301, 302, 334, 335, 336, 337}},
        {63, 24562, {4, 5, 8, 31, 55, 57, 59, 60, 61, 64, 69, 70, 82, 117, 285, 299, 300, 301, 302, 334, 335, 336, 337}},
        {64, 25074, {4, 5, 8, 31, 55, 57, 59, 60, 61, 64, 69, 70, 82, 117, 285, 299, 300, 301, 302, 334, 335, 336, 337}},
        {65, 25586, {4, 5, 8, 31, 55, 57, 59, 60, 61, 64, 69, 70, 82, 117, 285, 299, 300, 301, 302, 334, 335, 336, 337}},
        {66, 26098, {4, 5, 8, 31, 55, 57, 59, 60, 61, 64, 69, 70, 82, 117, 285, 299, 300, 301, 302, 334, 335, 336, 337}},
        {67, 26610, {4, 5, 8, 31, 55, 57, 59, 60, 61, 64, 69, 70, 82, 117, 285, 299, 300, 301, 302, 334, 335, 336, 337}},
        {68, 27122, {4, 5, 8, 31, 55, 57, 59, 60, 61, 64, 69, 70, 82, 117, 285, 299, 300, 301, 302, 334, 335, 336, 337}},
        {69, 27634, {4, 5, 8, 31, 55, 57, 59, 60, 61, 64, 69, 70, 82, 117, 285, 299, 300, 301, 302, 334, 335, 336, 337}},
        {70, 28146, {4, 5, 8, 31, 55, 57, 59, 60, 61, 64, 69, 70, 82, 117, 285, 299, 300, 301, 302, 334, 335, 336, 337}},
    ...
    const unsigned int           kHwDx11GroupCountGfx10                = sizeof(kHwDx11GroupsGfx10) / sizeof(GpaCounterGroupDesc);
    const unsigned int           kHwDx11ExposedCountersGroupCountGfx10 = 206;
