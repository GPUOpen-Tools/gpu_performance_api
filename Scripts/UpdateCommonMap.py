...
# Src.
    ...
    "common-src-DeviceInfo"               : ["../Common/Src/DeviceInfo",            "f5e7f3c8177e98d8333eed0e0f0cbc8114b8a621"],
...
downloadWin = {
    ...
    "GPADX11GetDeviceInfo" : [ "https://github.com/GPUOpen-Tools/GPA/releases/download/v3.4.1/GPUPerfAPI-3.4.1336.zip" , "default", "3_4", "../Common/Lib/AMD/GPUPerfAPI"]
}
