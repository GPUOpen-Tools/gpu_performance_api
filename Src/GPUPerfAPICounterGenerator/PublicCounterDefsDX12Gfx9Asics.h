...
/// \file
/// \brief PublicCounterDefinitions ASIC file for DX12GFX9
//==============================================================================

#ifndef _PUBLIC_COUNTER_DEFS_DX12GFX9_ASICS_H_
#define _PUBLIC_COUNTER_DEFS_DX12GFX9_ASICS_H_

//*** Note, this is an auto-generated file. Do not edit. Execute PublicCounterCompiler to rebuild.

#include "GPADerivedCounters.h"

#include "PublicCounterDefsDX12Gfx9_Gfx906.h"
...
inline void UpdatePublicAsicSpecificCounters(GDT_HW_GENERATION desiredGeneration, GDT_HW_ASIC_TYPE asicType, GPA_DerivedCounters& c)
{
    ...
    if (DX12Gfx9_Gfx906::UpdatePublicAsicSpecificCounters(desiredGeneration, asicType, c))
    {
        return;
    }

    if (DX12Gfx9_Placeholder4::UpdatePublicAsicSpecificCounters(desiredGeneration, asicType, c))
    {
        return;
    }
...
#endif // _PUBLIC_COUNTER_DEFS_DX12GFX9_ASICS_H_
