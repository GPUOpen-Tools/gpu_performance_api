...
const std::set<unsigned int> HWHSATimestampBlockIdsGfx7 = {  }; ///< Timestamp block id's for HSA for Gfx7 family
const std::set<unsigned int> HWHSATimeCounterIndicesGfx7 = {  }; ///< Timestamp counter indices for HSA for Gfx7 family
