...
/// \param[in, out] ppCounterAccessorOut Address of a IGPACounterAccessor pointer which will be set to the necessary counter accessor
/// \param[in, out] ppCounterSchedulerOut Address of a IGPACounterScheduler pointer which will be set to the necessary counter scheduler
