...
const char* oglUtils::s_pAMDRenderer = "AMD";
const char* oglUtils::s_pATIRenderer = "ATI";
const char* oglUtils::s_pNVIDIARenderer = "NVIDIA";
const char* oglUtils::s_pIntelRenderer = "Intel";
bool oglUtils::s_areGLFunctionsInitialized = false;
