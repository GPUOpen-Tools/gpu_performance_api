...
extern const unsigned int HWVKGPUTimeBottomToBottomIndexGfx8; ///< Index of EOP to EOP counter for VK for Gfx8 family
extern const unsigned int HWVKGPUTimeTopToBottomIndexGfx8; ///< Index of TOP to EOP counter for VK for Gfx8 family
