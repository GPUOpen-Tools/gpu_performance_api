...
void AutoDefinePublicCountersGLGfx6(GPA_PublicCounters& p)
{
    ...
    }
    {
        ...
        p.DefinePublicCounter("DBMemRead", "DepthAndStencil", "Number of bytes read from the depth buffer.", GPA_TYPE_FLOAT64, GPA_USAGE_TYPE_BYTES, GPA_COUNTER_TYPE_DYNAMIC, internalCounters, "0,1,+,(256),*,2,3,+,(32),*,+");
    }
    {
        vector< gpa_uint32 > internalCounters;
        ...
        p.DefinePublicCounter("DBMemWritten", "DepthAndStencil", "Number of bytes written to the depth buffer.", GPA_TYPE_FLOAT64, GPA_USAGE_TYPE_BYTES, GPA_COUNTER_TYPE_DYNAMIC, internalCounters, "0,1,+,(256),*,2,3,+,(32),*,+");
    }
    {
        vector< gpa_uint32 > internalCounters;
