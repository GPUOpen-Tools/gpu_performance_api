...
GPA_Status GPA_CounterGeneratorDX11Base::GeneratePublicCounters(GDT_HW_GENERATION    desiredGeneration,
...
GPA_Status GPA_CounterGeneratorDX11Base::GenerateHardwareCounters(GDT_HW_GENERATION     desiredGeneration,
                                                                  GDT_HW_ASIC_TYPE      asicType,
                                                                  gpa_uint8             generateAsicSpecificCounters,
...
GPA_Status GPA_CounterGeneratorDX11Base::GenerateSoftwareCounters(GDT_HW_GENERATION     desiredGeneration,
                                                                  GDT_HW_ASIC_TYPE      asicType,
                                                                  gpa_uint8             generateAsicSpecificCounters,
                                                                  GPA_SoftwareCounters* pSoftwareCounters)
{
    ...
    m_d3dCounterGroup.m_maxActiveDiscreteCounters = SwCounterManager::Instance()->GetNumSwCounters();
    m_d3dCounterGroup.m_maxActiveSpmCounters      = 0;
...
void GPA_CounterGeneratorDX11Base::ComputeSWCounterValue(gpa_uint32 softwareCounterIndex, gpa_uint64 value, void* pResult, const GPA_HWInfo* pHwInfo) const
{
