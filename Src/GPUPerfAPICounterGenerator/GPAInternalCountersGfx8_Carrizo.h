...
#ifndef _GPA_INTERNAL_COUNTERS_GFX8_CARRIZO_H_
#define _GPA_INTERNAL_COUNTERS_GFX8_CARRIZO_H_
...
inline bool OverrideBlockInstanceCounters(GDT_HW_ASIC_TYPE asicType)
{
    ...
    ReplaceBlockInstanceCounters(VGT0countersGfx8, VGT0countersGfx8_Carrizo, 146);
    ReplaceBlockInstanceCounters(VGT1countersGfx8, VGT1countersGfx8_Carrizo, 146);
    ReplaceBlockInstanceCounters(VGT2countersGfx8, VGT2countersGfx8_Carrizo, 146);
    ReplaceBlockInstanceCounters(VGT3countersGfx8, VGT3countersGfx8_Carrizo, 146);

    return true;
}
} // CounterGfx8_Carrizo

#endif // _GPA_INTERNAL_COUNTERS_GFX8_CARRIZO_H_
