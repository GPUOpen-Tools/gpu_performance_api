...
#ifndef _GPA_INTERNAL_COUNTERS_GFX8_ELLESMERE_H_
#define _GPA_INTERNAL_COUNTERS_GFX8_ELLESMERE_H_
...
{
    static std::set<GDT_HW_ASIC_TYPE> asicsSupported = { GDT_ELLESMERE };
...
inline bool OverrideBlockInstanceCounters(GDT_HW_ASIC_TYPE asicType)
{
    ...
    ReplaceBlockInstanceCounters(VGT0countersGfx8, VGT0countersGfx8_Ellesmere, 147);
    ReplaceBlockInstanceCounters(VGT1countersGfx8, VGT1countersGfx8_Ellesmere, 147);
    ReplaceBlockInstanceCounters(VGT2countersGfx8, VGT2countersGfx8_Ellesmere, 147);
    ReplaceBlockInstanceCounters(VGT3countersGfx8, VGT3countersGfx8_Ellesmere, 147);

    return true;
}
} // CounterGfx8_Ellesmere

#endif // _GPA_INTERNAL_COUNTERS_GFX8_ELLESMERE_H_
