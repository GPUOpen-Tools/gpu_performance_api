...
void AutoDefinePublicCountersHSAGfx9(GPA_PublicCounters& p)
{
    ...
    }
    {
        ...
        p.DefinePublicCounter("FlatLDSInsts", "LocalMemory", "The average number of FLAT instructions that read or write to LDS executed per work item (affected by flow control).", GPA_DATA_TYPE_FLOAT64, GPA_USAGE_TYPE_ITEMS, internalCounters, "0,1,/", "7b648dda-917a-5d05-49ac-028962103632" );
    }
    {
        vector< gpa_uint32 > internalCounters;
