...
/// \file
/// \brief PublicCounterDefinitions ASIC file for HSAGFX9
//==============================================================================

#ifndef _PUBLIC_COUNTER_DEFS_HSAGFX9_ASICS_H_
#define _PUBLIC_COUNTER_DEFS_HSAGFX9_ASICS_H_

//*** Note, this is an auto-generated file. Do not edit. Execute PublicCounterCompiler to rebuild.

#include "GPADerivedCounters.h"

#include "PublicCounterDefsHSAGfx9_Gfx906.h"
#include "PublicCounterDefsHSAGfx9_Placeholder4.h"

namespace HSAGfx9Asics
{
...
inline void UpdatePublicAsicSpecificCounters(GDT_HW_GENERATION desiredGeneration, GDT_HW_ASIC_TYPE asicType, GPA_DerivedCounters& c)
{
    ...
    if (HSAGfx9_Gfx906::UpdatePublicAsicSpecificCounters(desiredGeneration, asicType, c))
    {
        return;
    }

    if (HSAGfx9_Placeholder4::UpdatePublicAsicSpecificCounters(desiredGeneration, asicType, c))
    {
        return;
    }
...
#endif // _PUBLIC_COUNTER_DEFS_HSAGFX9_ASICS_H_
