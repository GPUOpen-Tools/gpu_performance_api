...
GPA_HardwareCounterDesc* CLCounterGroupArrayGfx6[] =
{
    CB0countersGfx6,
    CB1countersGfx6,
    CPcountersGfx6,
...
GPA_CounterGroupDesc HWCLGroupsGfx6[] =
{
    {0, "CB0", 0, 215, 4},
    {1, "CB1", 1, 215, 4},
    {2, "CP", 0, 46, 1},
...
GPA_SQCounterGroupDesc HWCLSQGroupsGfx6[] =
{
    {10, 0, SQ_ALL},
    {11, 0, SQ_ES},
    {12, 0, SQ_GS},
...
const std::set<unsigned int> HWCLTimestampBlockIdsGfx6 = {  }; ///< Timestamp block id's for CL for Gfx6 family
const std::set<unsigned int> HWCLTimeCounterIndicesGfx6 = {  }; ///< Timestamp counter indices for CL for Gfx6 family
