...
private:
    ...
    public:
        ...
        /// \RChecks whether the data has been collected or not for the monitor
        /// \return true upon successful operation otherwise false
        ...
        /// \param[in,opt] forceClear flag indicating whether the monitor needs to be deleted even if it's data is not populated
        /// \return true upon successful operation otherwise false
