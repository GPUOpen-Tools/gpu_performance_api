...
const GPACounterDesc HSAGFX7_PUBLIC_COUNTERS[HSAGFX7_PUBLIC_COUNTER_COUNT] =
{
    ...
    {"FlatLDSInsts", "LocalMemory", "The average number of FLAT instructions that read from or write to LDS executed per work item (affected by flow control).", GPA_TYPE_FLOAT64, GPA_USAGE_TYPE_ITEMS},
