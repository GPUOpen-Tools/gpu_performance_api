...
#include "PublicDerivedCountersCLGfx7.h"

const GPACounterDesc CLGFX7_PUBLIC_COUNTERS[CLGFX7_PUBLIC_COUNTER_COUNT] =
{
    ...
    {"VFetchInsts", "General", "The average number of vector fetch instructions from the video memory executed per work-item (affected by flow control).", GPA_DATA_TYPE_FLOAT64, GPA_USAGE_TYPE_ITEMS, {0xd45b0277, 0x03fa, 0x9480, {0xea, 0xda, 0x48, 0x71, 0xec, 0x89, 0xc5, 0x04}}},
    ...
    {"VWriteInsts", "General", "The average number of vector write instructions to the video memory executed per work-item (affected by flow control).", GPA_DATA_TYPE_FLOAT64, GPA_USAGE_TYPE_ITEMS, {0xd33f2e7c, 0x3198, 0xcf69, {0x24, 0x32, 0xd2, 0xa3, 0x2f, 0x38, 0x5d, 0x46}}},
    ...
    {"LDSInsts", "LocalMemory", "The average number of LDS read or LDS write instructions executed per work item (affected by flow control). Excludes FLAT instructions that read from or write to LDS.", GPA_DATA_TYPE_FLOAT64, GPA_USAGE_TYPE_ITEMS, {0xbe9bbead, 0xf82a, 0xa2c6, {0x83, 0x33, 0x1a, 0x5c, 0x4c, 0xe5, 0xee, 0x98}}},
    {"FlatLDSInsts", "LocalMemory", "The average number of FLAT instructions that read from or write to LDS executed per work item (affected by flow control).", GPA_DATA_TYPE_FLOAT64, GPA_USAGE_TYPE_ITEMS, {0x0f7d8f58, 0x1750, 0xa36f, {0xd0, 0x3e, 0x85, 0xa2, 0xd9, 0xcd, 0x6e, 0x08}}},
    ...
    {"CacheHit", "GlobalMemory", "The percentage of fetch, write, atomic, and other instructions that hit the data cache. Value range: 0% (no hit) to 100% (optimal).", GPA_DATA_TYPE_FLOAT64, GPA_USAGE_TYPE_PERCENTAGE, {0xdfbeebab, 0xf7c1, 0x1211, {0xe5, 0x02, 0x4a, 0xae, 0x36, 0x1e, 0x2a, 0xd7}}},
