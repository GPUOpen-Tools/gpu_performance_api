...
#include "PublicCountersDX11Gfx9.h"

const GPACounterDesc DX11GFX9_PUBLIC_COUNTERS[DX11GFX9_PUBLIC_COUNTER_COUNT] =
{
    ...
    {"CSL1CacheHit", "ComputeShader", "The percentage of fetch, write, atomic, and other instructions that hit the data in L1 cache. Value range: 0% (no hit) to 100% (optimal).", GPA_TYPE_FLOAT64, GPA_USAGE_TYPE_PERCENTAGE},
    {"CSL1CacheHitCount", "ComputeShader", "Count of fetch, write, atomic, and other instructions that hit the data in L1 cache.", GPA_TYPE_FLOAT64, GPA_USAGE_TYPE_ITEMS},
    {"CSL1CacheMissCount", "ComputeShader", "Count of fetch, write, atomic, and other instructions that miss the data in L1 cache.", GPA_TYPE_FLOAT64, GPA_USAGE_TYPE_ITEMS},
    {"CSL2CacheHit", "ComputeShader", "The percentage of fetch, write, atomic, and other instructions that hit the data in L2 cache. Value range: 0% (no hit) to 100% (optimal).", GPA_TYPE_FLOAT64, GPA_USAGE_TYPE_PERCENTAGE},
    {"CSL2CacheHitCount", "ComputeShader", "Count of fetch, write, atomic, and other instructions that hit the data in L2 cache.", GPA_TYPE_FLOAT64, GPA_USAGE_TYPE_ITEMS},
    {"CSL2CacheMissCount", "ComputeShader", "Count of fetch, write, atomic, and other instructions that miss the data in L2 cache.", GPA_TYPE_FLOAT64, GPA_USAGE_TYPE_ITEMS},
