...
bool VkGPAImplementor::CloseAPIContext(GPADeviceIdentifier pDeviceIdentifier, IGPAContext* pGpaContext)
{
    ...
    {
        delete reinterpret_cast<VkGPAContext*>(pGpaContext);
    }

    return (nullptr != pGpaContext);
}
