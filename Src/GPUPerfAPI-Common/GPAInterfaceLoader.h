...
static void Win2UnixPathSeparator(LocaleChar* pFilePath, unsigned int* pLastSeparatorPosition)
{
...
static const LocaleChar* GPAIL_GetLibraryFileName(GPA_API_Type pApiType)
{
...
static const LocaleChar* GPAIL_GetLibraryFullPath(GPA_API_Type apiType, const LocaleChar* pLibPath)
{
...
static GPA_Status GPAIL_LoadApi(GPA_API_Type apiType, const LocaleChar* pLibPath)
{
...
static const GPAFunctionTable* GPAIL_GetFunctionTable(GPA_API_Type apiType)
{
    GPAFuncTableInfo* pFunctionTableInfo = g_pFuncTableInfo;
...
/// \param[in] apiType API type
/// \return GPA_STATUS_OK upon successful operation
static GPA_Status GPAIL_UnLoadApi(GPA_API_Type apiType)
{
    GPA_Status status = GPA_STATUS_ERROR_FAILED;
