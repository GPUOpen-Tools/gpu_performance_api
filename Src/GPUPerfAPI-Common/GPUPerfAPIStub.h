...
static GPA_Status GPA_RegisterLoggingCallback(
...
static GPA_Status GPA_Initialize(
    GPA_InitializeFlags flags)
{
    RETURN_GPA_SUCCESS;
}

static GPA_Status GPA_Destroy()
{
    RETURN_GPA_SUCCESS;
}
...
static GPA_Status GPA_OpenContext(
    void* pContext,
...
static GPA_Status GPA_CloseContext(
...
static GPA_Status GPA_GetSupportedSampleTypes(
    GPA_ContextId contextId,
...
static GPA_Status GPA_GetDeviceAndRevisionId(
    GPA_ContextId contextId,
...
static GPA_Status GPA_GetDeviceName(
    GPA_ContextId contextId,
...
static GPA_Status GPA_GetNumCounters(
    GPA_ContextId contextId,
    gpa_uint32* pCount)
{
    RETURN_GPA_SUCCESS;
...
static GPA_Status GPA_GetCounterName(
    GPA_ContextId contextId,
    gpa_uint32 index,
    const char** ppName)
{
...
static GPA_Status GPA_GetCounterIndex(
    GPA_ContextId contextId,
...
static GPA_Status GPA_GetCounterGroup(
    GPA_ContextId contextId,
    gpa_uint32 index,
    const char** ppGroup)
{
...
static GPA_Status GPA_GetCounterDescription(
    GPA_ContextId contextId,
    gpa_uint32 index,
...
static GPA_Status GPA_GetCounterDataType(
    GPA_ContextId contextId,
    gpa_uint32 index,
...
static GPA_Status GPA_GetCounterUsageType(
    GPA_ContextId contextId,
    gpa_uint32 index,
...
static GPA_Status GPA_GetCounterUuid(
    GPA_ContextId contextId,
    gpa_uint32 index,
...
static GPA_Status GPA_GetCounterSampleType(
    GPA_ContextId contextId,
    gpa_uint32 index,
...
static GPA_Status GPA_GetDataTypeAsStr(
...
static GPA_Status GPA_GetUsageTypeAsStr(
...
static GPA_Status GPA_CreateSession(
    GPA_ContextId contextId,
...
static GPA_Status GPA_DeleteSession(
    GPA_SessionId sessionId)
{
    RETURN_GPA_SUCCESS;
}

static GPA_Status GPA_BeginSession(
    GPA_SessionId sessionId)
{
    RETURN_GPA_SUCCESS;
}

static GPA_Status GPA_EndSession(
    GPA_SessionId sessionId)
{
    RETURN_GPA_SUCCESS;
}
...
static GPA_Status GPA_EnableCounter(
    GPA_SessionId sessionId,
    gpa_uint32 index)
{
    RETURN_GPA_SUCCESS;
...
static GPA_Status GPA_DisableCounter(
    GPA_SessionId sessionId,
    gpa_uint32 index)
{
    RETURN_GPA_SUCCESS;
...
static GPA_Status GPA_EnableCounterByName(
    GPA_SessionId sessionId,
    const char* pCounterName)
{
    RETURN_GPA_SUCCESS;
...
static GPA_Status GPA_DisableCounterByName(
    GPA_SessionId sessionId,
    const char* pCounterName)
{
    RETURN_GPA_SUCCESS;
...
static GPA_Status GPA_EnableAllCounters(
    GPA_SessionId sessionId)
{
    RETURN_GPA_SUCCESS;
}

static GPA_Status GPA_DisableAllCounters(
    GPA_SessionId sessionId)
{
    RETURN_GPA_SUCCESS;
}
...
static GPA_Status GPA_GetPassCount(
    GPA_SessionId sessionId,
...
static GPA_Status GPA_GetNumEnabledCounters(
    GPA_SessionId sessionId,
    gpa_uint32* pCount)
{
    RETURN_GPA_SUCCESS;
...
static GPA_Status GPA_GetEnabledIndex(
    GPA_SessionId sessionId,
...
static GPA_Status GPA_IsCounterEnabled(
    GPA_SessionId sessionId,
...
static GPA_Status GPA_BeginCommandList(
    GPA_SessionId sessionId,
...
static GPA_Status GPA_EndCommandList(
    GPA_CommandListId commandListId)
{
    RETURN_GPA_SUCCESS;
}

static GPA_Status GPA_BeginSample(
    gpa_uint32 sampleId,
    GPA_CommandListId commandListId)
{
    RETURN_GPA_SUCCESS;
...
static GPA_Status GPA_EndSample(
    GPA_CommandListId commandListId)
{
    RETURN_GPA_SUCCESS;
}

static GPA_Status GPA_ContinueSampleOnCommandList(
...
static GPA_Status GPA_CopySecondarySamples(
...
static GPA_Status GPA_GetSampleCount(
    GPA_SessionId sessionId,
...
static GPA_Status GPA_IsSessionComplete(
    GPA_SessionId sessionId)
{
    RETURN_GPA_SUCCESS;
}

static GPA_Status GPA_GetSampleResultSize(
    GPA_SessionId sessionId,
    gpa_uint32 sampleId,
...
static GPA_Status GPA_GetSampleResult(
    GPA_SessionId sessionId,
    gpa_uint32 sampleId,
    size_t sampleResultSizeInBytes,
...
static const char* GPA_GetStatusAsStr(
    GPA_Status status)
{
    return NULL;
}
...
static GPA_Status GPA_GetFuncTable(void* pGPAFuncTable)
{
    ...
    int correctMajorVersion = GPA_FUNCTION_TABLE_MAJOR_VERSION_NUMBER == pLocalFuncTable->m_majorVer ? 1 : 0;
