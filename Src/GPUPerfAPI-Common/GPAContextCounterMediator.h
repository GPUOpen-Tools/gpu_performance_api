...
public:
    ...
    GPA_Status GenerateCounters(const IGPAContext* pGpaContext,
    ...
    /// \return GPA_STATUS_OK upon successful operation
    GPA_Status ScheduleCounters(const IGPAContext* pGpaContext,
    ...
    /// \param[in] counterSet set of counter
    /// \return GPA_STATUS_OK upon successful operation
    GPA_Status UnscheduleCounters(const IGPAContext* pGpaContext,
                                  const IGPASession* pGpaSession,
                                  const std::vector<gpa_uint32>& counterSet);
    ...
    /// \param[in] counterSet set of counter
    /// \return GPA_STATUS_OK upon successful operation
    GPA_Status GetRequiredPassCount(const IGPAContext* pGpaContext,
                                    const std::vector<gpa_uint32>& counterSet,
