...
inline bool OverrideBlockInstanceCounters(GDT_HW_ASIC_TYPE asicType)
{
    ...
    ReplaceBlockInstanceCounters(CounterGfx8::VGT0countersGfx8, VGT0countersGfx8_Tonga, 147);
    ReplaceBlockInstanceCounters(CounterGfx8::VGT1countersGfx8, VGT1countersGfx8_Tonga, 147);
    ReplaceBlockInstanceCounters(CounterGfx8::VGT2countersGfx8, VGT2countersGfx8_Tonga, 147);
    ReplaceBlockInstanceCounters(CounterGfx8::VGT3countersGfx8, VGT3countersGfx8_Tonga, 147);
