...
namespace CounterGfx9
{
    ...
    extern GPA_HardwareCounterDesc*           DX11ExposedCountersGroupArrayGfx9[]; ///< Array of hardware exposed counter groups for DX11 for Gfx9 family
    extern GPA_CounterGroupDesc               HWDX11GroupsGfx9[]; ///< Array of counter groups for DX11 for Gfx9 family
    extern GPA_CounterGroupExposedCounterDesc HWDX11ExposedCountersByGroupGfx9[]; ///< Array of exposed counter groups for DX11 for Gfx9 family
    extern GPA_PaddedCounterDesc              DX11PaddedCounterByGroupGfx9[]; ///< Array of reserved counter for DX11 for Gfx9 family
    ...
    extern const unsigned int                 HWDX11ExposedCountersGroupCountGfx9; ///< Whitelist hardware counter Group Count for DX11 for Gfx9 family
    extern const unsigned int                 DX11PaddedCounterGroupCountGfx9; ///< reserved counter group count for DX11 for Gfx9 family
