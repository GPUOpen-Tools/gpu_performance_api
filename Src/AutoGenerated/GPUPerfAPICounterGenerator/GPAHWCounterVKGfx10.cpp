...
{
    GPA_HardwareCounterDesc* VKCounterGroupArrayGfx10[] = {
        CPFcountersGfx10,
        PA_SU0countersGfx10,
        PA_SU1countersGfx10,
        PA_SU2countersGfx10,
    ...
    GPA_HardwareCounterDesc* VKExposedCountersGroupArrayGfx10[] = {
    ...
    GPA_CounterGroupDesc HWVKGroupsGfx10[] = {
        {0, "CPF", 0, 40, 2, 4},
        {1, "PA_SU0", 0, 266, 4, 16},
        {2, "PA_SU1", 1, 266, 4, 16},
        {3, "PA_SU2", 2, 266, 4, 16},
    ...
    GPA_CounterGroupExposedCounterDesc HWVKExposedCountersByGroupGfx10[] = {
        {0, 0, {0, 24}},
    ...
    GPA_PaddedCounterDesc VKPaddedCounterByGroupGfx10[] = {
    {}
    };

    GPA_SQCounterGroupDesc HWVKSQGroupsGfx10[] = {
        {29, 0, SQ_ALL},
        {30, 1, SQ_ALL},
        {31, 2, SQ_ALL},
        {32, 3, SQ_ALL},
    ...
    unsigned int HWVKSQIsolatedGroupsGfx10[] = {
        69, // Ta
        70, // Ta
        71, // Ta
        72, // Ta
    ...
    VkGpaPerfBlockAMD HWVKDriverEnumGfx10[] = {
    ...
    const unsigned int HWVKGputimeBottomToBottomDurationIndexGfx10 = 103173; ///< Index of delta between the previous command reaching bottom of pipe and the current command reaching bottom of pipe, will not include latency of first data to travel through pipeline, best for large data sets. for VK for Gfx10 family
    const unsigned int HWVKGputimeBottomToBottomStartIndexGfx10 = 103174; ///< Index of time of the previous command reaching bottom of pipe for VK for Gfx10 family
    const unsigned int HWVKGputimeBottomToBottomEndIndexGfx10 = 103175; ///< Index of time of the current command reaching bottom of pipe for VK for Gfx10 family
    const unsigned int HWVKGputimeTopToBottomDurationIndexGfx10 = 103176; ///< Index of execution duration of the current command from top of pipe to bottom of pipe, may include overhead of time in queue for VK for Gfx10 family
    const unsigned int HWVKGputimeTopToBottomStartIndexGfx10 = 103177; ///< Index of time that the current command reaches the top of pipe for VK for Gfx10 family
    const unsigned int HWVKGputimeTopToBottomEndIndexGfx10 = 103178; ///< Index of time that the current command reaches the bottom of pipe for VK for Gfx10 family
    const std::set<unsigned int> HWVKTimestampBlockIdsGfx10 =       {534}; ///< Timestamp block id's for VK for Gfx10 family
    const std::set<unsigned int> HWVKTimeCounterIndicesGfx10 =      {103173, 103174, 103175, 103176, 103177, 103178}; ///< Timestamp counter indices for VK for Gfx10 family
    const unsigned int           HWVKGroupCountGfx10                = sizeof(HWVKGroupsGfx10) / sizeof(GPA_CounterGroupDesc);
    const unsigned int           HWVKExposedCountersGroupCountGfx10 = 344;
    const unsigned int           VKPaddedCounterGroupCountGfx10 = 0;
    const unsigned int           HWVKSQGroupCountGfx10              = sizeof(HWVKSQGroupsGfx10) / sizeof(GPA_SQCounterGroupDesc);
    const unsigned int           HWVKSQIsolatedGroupCountGfx10      = sizeof(HWVKSQIsolatedGroupsGfx10) / sizeof(unsigned int);
}; // namespace
