...
namespace CounterGfx9
{
    ...
    GPA_HardwareCounterDesc* VKExposedCountersGroupArrayGfx9[] = {
    ...
    GPA_CounterGroupExposedCounterDesc HWVKExposedCountersByGroupGfx9[] = {
        {0, 0, {0, 23}},
    ...
    GPA_PaddedCounterDesc VKPaddedCounterByGroupGfx9[] = {
    ...
    const unsigned int HWVKGputimeBottomToBottomDurationIndexGfx9 = 56575; ///< Index of delta between the previous command reaching bottom of pipe and the current command reaching bottom of pipe, will not include latency of first data to travel through pipeline, best for large data sets. for VK for Gfx9 family
    const unsigned int HWVKGputimeBottomToBottomStartIndexGfx9 = 56576; ///< Index of time of the previous command reaching bottom of pipe for VK for Gfx9 family
    const unsigned int HWVKGputimeBottomToBottomEndIndexGfx9 = 56577; ///< Index of time of the current command reaching bottom of pipe for VK for Gfx9 family
    const unsigned int HWVKGputimeTopToBottomDurationIndexGfx9 = 56578; ///< Index of execution duration of the current command from top of pipe to bottom of pipe, may include overhead of time in queue for VK for Gfx9 family
    const unsigned int HWVKGputimeTopToBottomStartIndexGfx9 = 56579; ///< Index of time that the current command reaches the top of pipe for VK for Gfx9 family
    const unsigned int HWVKGputimeTopToBottomEndIndexGfx9 = 56580; ///< Index of time that the current command reaches the bottom of pipe for VK for Gfx9 family
    const std::set<unsigned int> HWVKTimestampBlockIdsGfx9 =       {369}; ///< Timestamp block id's for VK for Gfx9 family
    const std::set<unsigned int> HWVKTimeCounterIndicesGfx9 =      {56575, 56576, 56577, 56578, 56579, 56580}; ///< Timestamp counter indices for VK for Gfx9 family
    const unsigned int           HWVKGroupCountGfx9                = sizeof(HWVKGroupsGfx9) / sizeof(GPA_CounterGroupDesc);
    const unsigned int           HWVKExposedCountersGroupCountGfx9 = 247;
    const unsigned int           VKPaddedCounterGroupCountGfx9 = 41;
