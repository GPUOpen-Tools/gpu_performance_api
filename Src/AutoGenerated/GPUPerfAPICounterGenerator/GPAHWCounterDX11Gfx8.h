...
namespace CounterGfx8
{
    ...
    extern GPA_HardwareCounterDesc*           DX11ExposedCountersGroupArrayGfx8[]; ///< Array of hardware exposed counter groups for DX11 for Gfx8 family
    extern GPA_CounterGroupDesc               HWDX11GroupsGfx8[]; ///< Array of counter groups for DX11 for Gfx8 family
    extern GPA_CounterGroupExposedCounterDesc HWDX11ExposedCountersByGroupGfx8[]; ///< Array of exposed counter groups for DX11 for Gfx8 family
    extern GPA_PaddedCounterDesc              DX11PaddedCounterByGroupGfx8[]; ///< Array of reserved counter for DX11 for Gfx8 family
    ...
    extern const unsigned int                 HWDX11ExposedCountersGroupCountGfx8; ///< Whitelist hardware counter Group Count for DX11 for Gfx8 family
    extern const unsigned int                 DX11PaddedCounterGroupCountGfx8; ///< reserved counter group count for DX11 for Gfx8 family
